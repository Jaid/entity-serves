...
```bash
npm install --global entity-serves@^3.3.0
```
...
```bash
yarn global add entity-serves@^3.3.0
```
...
```bash
npm install --global @jaid/entity-serves@^3.3.0
```
